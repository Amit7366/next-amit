    ...
    >
      <div className="w-full flex flex-col md:flex-row max-w-[1440px] mx-auto p-5">
        <div className="w-full md:w-1/2">
            <h1 className="text-white">I  am <span className="text-2xl font-bold text-yellow-500">Amit Kumar</span></h1>
            <h2 className="text-white my-3">Full Stack Web Developer</h2>
